...
@InstanceRestoration
public abstract class IziActivityO extends AppCompatActivity implements LifecycleDelegatesO<IziActivityO>, Serializable {
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstance != null) {
            onRestoration((IziActivityO) savedInstance);
        }
    }
